...
<div class="row">
    ...
    <div class="well col-md-12 ">
        <form role="form" action="./user" method="post">
            ...
            <div class="form-group col-md-12">
                <label class="control-label"for="exampleInputPassword1"><h5>创建日期</h5></label>
                <input type="text" name="password" class="form-control" id="exampleInputPassword1" value="<c:out value="${user.addon}" > </c:out>">
            </div>

            <div class="form-group  col-md-12">
                <label class="control-label"for="iphone-toggle"><h5>是否准许登录</h5></label>
                <input data-no-uniform="true" value="on"name="canLogin" type="checkbox" id="iphone-toggle"class="iphone-toggle">
            </div>
